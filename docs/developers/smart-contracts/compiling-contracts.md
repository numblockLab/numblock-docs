...
You need to compile your contract so that your web app and the NumBlock virtual machine (EVM) can understand it.

## Prerequisites {#prerequisites}

You might find it helpful to have read our intro to [smart contracts](/docs/developers/smart-contracts/) before reading about compilation.
...
Below is the ABI for the ERC-20 token contract. An ERC-20 is a token you can trade on NumBlock.

...
A smart contract is a program that runs at an address on NumBlock. They're made up of data and functions that can execute upon receiving a transaction. Here's an overview of what makes up a smart contract.

### Prerequisites {#prerequisites}

Make sure you've read about [smart contracts](/docs/developers/smart-contracts/) first. This document assumes you're already familiar with programming languages such as JavaScript or Python.
...
If you've already programmed object-oriented languages, you'll likely be familiar with most types. However `address` should be new to you if you're new to NumBlock development.

An `address` type can hold an NumBlock address which equates to 20 bytes or 160 bits. It returns in hexadecimal notation with a leading 0x.
...
constructor() public {
    ...
    // such as the address of the sender and the NUMB value included in the transaction.
...
These allow contracts to send NUMB to other accounts.
...
These are some examples written in Solidity. If you'd like to play with the code, you can interact with them in [Remix](https://remix-project.org/).
...
// Once deployed, a contract resides at a specific address on the NumBlock blockchain.
...
contract Token {
    // An `address` is comparable to an email address - it's used to identify an account on NumBlock.
    ...
    // NumBlock clients can listen for events in order to react to contract state changes.
...
contract CryptoPizza is IERC721, ERC165 {
    ...
    */
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // See https://NumBlock.stackexchange.com/a/14016/36603
...
Check out Solidity documentation for a more complete overview of smart contracts:

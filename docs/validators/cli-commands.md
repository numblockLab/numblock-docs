...
id: cli-commands
title: CLI Commands
description: "List of CLI commands and command flags for NumBlock."
keywords:
  - docs
  - cli
  - commands
...
This section details the present commands, command flags in the NumBlock, and how they're used.
...
| **All server flags**                                                                        |
|---------------------------------------|---------------------------------------------|
| [data-dir](/docs/validators/cli-commands#data-dir) | [jsonrpc](/docs/validators/cli-commands#jsonrpc) | 
| [json-rpc-block-range-limit](/docs/validators/cli-commands#json-rpc-block-range-limit) | [json-rpc-batch-request-limit](/docs/validators/cli-commands#json-rpc-batch-request-limit) |
|[grpc](/docs/validators/cli-commands#grpc) | [libp2p](/docs/validators/cli-commands#libp2p) | 
| [prometheus](/docs/validators/cli-commands#prometheus) | [block-gas-target](/docs/validators/cli-commands#block-gas-target) | 
| [max-peers](/docs/validators/cli-commands#max-peers) | [max-inbound-peers](/docs/validators/cli-commands#max-inbound-peers) |
| [max-outbound-peers](/docs/validators/cli-commands#max-outbound-peers) | [max-enqueued](/docs/validators/cli-commands#max-enqueued) |
| [log-level](/docs/validators/cli-commands#log-level) | [log-to](/docs/validators/cli-commands#log-to) |
| [chain](/docs/validators/cli-commands#chain) | [join](/docs/validators/cli-commands#join) |
| [nat](/docs/validators/cli-commands#nat) | [dns](/docs/validators/cli-commands#dns) | 
| [price-limit](/docs/validators/cli-commands#price-limit) | [max-slots](/docs/validators/cli-commands#max-slots) |
| [config](/docs/validators/cli-commands#config) | [secrets-config](/docs/validators/cli-commands#secrets-config) | 
| [dev](/docs/validators/cli-commands#dev) | [dev-interval](/docs/validators/cli-commands#dev-interval) | 
| [no-discover](/docs/validators/cli-commands#no-discover) | [restore](/docs/validators/cli-commands#restore) | 
| [block-time](/docs/validators/cli-commands#block-time) | [access-control-allow-origins](/docs/validators/cli-commands#access-control-allow-origins) |
...
Used to specify the data directory used for storing NumBlock client data. Default: `./test-chain`.
...
A more detailed explanation on the block gas target can be found in the [TxPool section](/docs/architecture/modules/txpool).
...
| secrets generate         | Generates a secrets manager configuration file which can be parsed by the NumBlock    |
...
Sets the directory for the NumBlock data if the local FS is used.

...
The **Interconnect** module contains the logic for the synchronization protocol.

The NumBlock uses **libp2p** as the P2P network layer, and on top of that runs **gRPC**.

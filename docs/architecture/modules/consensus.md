...
The **Consensus Engine** module provides an interface for consensus mechanisms.

The NumBlock wants to maintain a state of modularity and pluggability. <br />
...
To review the fields present in the block header, please check out the **[State in NumBlock](/docs/foundational-topics/state#blocks)** section.
...
Validators include voting information in the **Validator** header filed, and change the value of the **nonce**:
...
To start up IBFT, the NumBlockfirstly needs to set up the IBFT transport:
...
The messages are meant to be used by validators. The NumBlockthen subscribes to the topic and handles messages accordingly.
